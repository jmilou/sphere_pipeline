...
for i in range(cube_psf.shape[0]):# psf1 in cube_psf:
    ...
    i+=1
    strehls.append(calc_strehl(psf1, oversample=oversample, oc=0, FIT=True, SUBSTRACT_NOISE=True,VISU=False, VERBOSE=False,ABS=True, PUPIL=True, APO='APO1',LYOT='ALC2',path=path, path_lib=path_lib, outliers=outliers))
